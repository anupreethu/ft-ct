<template>
    <div class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>our menu</h3>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Interior Painting</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Exterior painting</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Water Proofing</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Wall Texture
                </router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i>Wood Coatings</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Wallpapers</router-link>
            </div>
            ...
            <div class="box">
                ...
                <router-link @click="scrollToTop()" to="/promotions"> <i class="fas fa-arrow-right"></i> Services
                </router-link>
                <router-link @click="scrollToTop()" to="/menu"> <i class="fas fa-arrow-right"></i> menu</router-link>
                <router-link @click="scrollToTop()" to="/table"> <i class="fas fa-arrow-right"></i>Appointment
                </router-link>
            </div>
            ...
            <div class="box">
                <h3>Safe And Hassle-Free Express Home Painting
With Berger Express Painting Service</h3>
                <p>Here Is What Makes Express Painting A Great Choice</p>
