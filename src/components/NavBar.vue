<template>
  <div class="header">
    <router-link @click="scrollToTop()" to="/" class="logo">
      <img src="../assets/images/taco-logo.png" alt="" />Mikepaints
    </router-link>
    ...
    <nav class="navbar">
      ...
      <router-link @click="scrollToTop()" to="/promotions">Services</router-link>
      <router-link @click="scrollToTop()" to="/menu">menu</router-link>
      <router-link @click="scrollToTop()" to="/table">Appointment</router-link>
    </nav>
...
<style scoped>
/* Add styles for the user greeting */
.user-greeting {
  background: #f38609;
  color: white;
  border-radius: 50%;
