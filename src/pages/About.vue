    ...
    <section class="about-section">
        ...
        <div class="row">
            <div class="about-content">
                ...
                <div class="about-content-text">
                    <p>Welcome to our home paint website, where we're passionate about the art of transforming houses into welcoming homes. With a commitment to simplifying your home improvement journey, we offer a comprehensive range of high-quality paints and expert guidance. Our mission is to empower you with the tools and inspiration needed to effortlessly elevate your living spaces. Explore our diverse selection of paint colors and discover valuable insights to embark on your next project with confidence. Together, let's embark on a colorful and creative journey to make your home uniquely yours, one brushstroke at a time.</p>
        ...
        <div class="row">
            <div class="about-article">
                <h3>Your Partner In Home Transformation</h3>
            </div>
        </div>
