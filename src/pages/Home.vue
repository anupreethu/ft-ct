<template>
    <div>
        <div class="home-main">
            <div class="content">
                <span>welcome</span>
                <h3>Why choose the Beautiful Homes Service?!</h3>
                <p>Your home is all about you. From the first call, we try to understand you and your expectations from a living space. Our designers work with you on finding the right balance between aesthetics and functionality, while our project manager ensures that budget, time and quality goals are met.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">Book now</router-link>
            </div>
            <div class="image">
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <h3 class="title">we've been trusted by thousands of families</h3>
                <p>a home painting service by MikePaints India that offers at-home consultancy, accurate estimation, skilled painters, regular site supervision and dust-free experience.

The painters are experts in their craft and provide a safe and healthy environment for your home. You can use this service to paint your entire house or just one room,paints are great for painting your home because they're affordable. You won't have to worry about paying extra for high-quality paints from a company that sells cheap products. You'll also be able to paint your entire home with a single coat of paint, which saves time and money.</p>
                ...
                <div class="icons-container">
                    ...
                    <div class="icons">
                        ...
                        <h3>Color Consultation Experts</h3>
                    </div>
                </div>
            </div>
        </div>
