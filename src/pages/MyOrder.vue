...
export default {
    ...
    data() {
        return {
            avaiableStatus: ["cancel", "order for paint confirmed", "preparing your paint order", "Quality check for your paint order", "Delivering your paint order", "Paint order delivered "],
            allBills: [],
