    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>02 Duong Khue,United States</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="input-box">
                    <label for="uPhone">Contact Number</label>
            ...
            <div class="row">
                <div class="input-box">
                    <label for="oPeople">Number of Rooms</label>
                ...
                <div class="input-box">
                    <label for="oTables">Types of Painting Service</label>
                    <input type="text" name="oTables" id="oTables" v-model="orderObj.tables">
            ...
            <div class="row">
                <div class="input-box">
                    ...
                    <textarea placeholder="Any Specific Requests?" name="uMessage"
